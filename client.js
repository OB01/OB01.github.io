...
;( function( window ) {
	...
	ifrm.setAttribute("src", "https://persistent.id/client.html#"+window.location.href);
	...
	function uuid(evt) {
		var message;
		if (evt.origin !== "https://persistent.id") {
	...
	// Message listener (calls uuid function)
	if(window.addEventListener){window.addEventListener("message",uuid,false);}else{window.attachEvent("onmessage",uuid);}
